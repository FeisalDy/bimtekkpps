  ...
  return (
    <section className='flex flex-col items-center justify-center w-full px-5 mt-16 sm:mt-24 md:mt-32 sm:px-10 md:px-24 sxl:px-32'>
      ...
      <div className='grid grid-cols-2 grid-rows-2 gap-6 mt-10 sm:mt-16'>
        <article className='relative hidden col-span-2 row-span-2 md:grid md:col-span-1'>
          <BlogLayoutOne blog={sortedBlogs[0]} />
        </article>
        <article className='relative grid col-span-2 row-span-1 sm:col-span-1 md:hidden'>
